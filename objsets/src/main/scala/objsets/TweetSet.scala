...
class Empty extends TweetSet {
  ...
  def mostRetweeted: Tweet = new Tweet("nullTweet", "nullTweet", -1)
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def descendingByRetweet: TweetList = new NonEmptyTweetList(this.mostRetweeted, this.remove(this.mostRetweeted).descendingByRetweet)
...
class NonEmptyTweetList(val head: Tweet, val tail: TweetList) extends TweetList {
  def isEmpty = false
}
...
object Main extends App {
  ...
  //  println("===================")
  //  println("Google keyWords")
  //  println("===================")
  //  GoogleVsApple.google foreach println
  //  println("===================")
  //  println("Apple keyWords")
  //  println("===================")
  //  GoogleVsApple.apple foreach println
  //  println("===================")
  //  println("All tweets")
  //  println("===================")
