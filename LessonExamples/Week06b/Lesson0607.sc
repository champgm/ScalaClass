...
object Lesson0607 {
  ...
  val input = Source.fromFile("/linuxwords.txt")  //> input  : scala.io.BufferedSource = non-empty iterator
  ...
  val numberMap = Map(
    ...
    ('7', "PQRS"),
    ('8', "TUV"),
    ('9', "WXYZ"))                                //> numberMap  : scala.collection.immutable.Map[Char,String] = Map(8 -> TUV, 4 -
